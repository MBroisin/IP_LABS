...
public class Correlate_Kernel_2D implements PlugIn {
	...
	public void run(String arg) {
		...
		GenericDialog gd = new GenericDialog("Correlate Square Kernel");
		...
		ImageAccess out = (new Code()).correlate(input, sigma, orderX, orderY);
		out.show("Correlate (" + orderX + ", " + orderY + ")");
