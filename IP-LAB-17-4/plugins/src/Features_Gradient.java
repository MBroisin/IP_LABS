...
public class Features_Gradient implements PlugIn {
	...
	public void run(String arg) {
		...
		GenericDialog gd = new GenericDialog("Features Gradient");
		...
		ImageAccess[] out = (new Code()).gradient(input, sigma);
		for(ImageAccess o : out)
			o.show("Features Gradient (" + sigma + ")");
	}
}
