...
public class Code {
	...
	private ImageAccess synthesize1(ImageAccess in, int order) {
		...
		ImageAccess HL = convolve(upsample(in.getSubImage(in.nx/2, 0, in.nx/2, in.ny/2)), Hainv, Gainv);
		ImageAccess LH = convolve(upsample(in.getSubImage(0, in.ny/2, in.nx/2, in.ny/2)), Gainv, Hainv);
